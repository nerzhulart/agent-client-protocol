...
class ClientSideConnectionTest {
    ...
    fun `test readTextFile handler calls client and returns response`() = runTest {
        ...
        val requestJson = """{"jsonrpc":"2.0","id":42,"method":"fs/read_text_file","params":${ACPJson.encodeToString(ReadTextFileRequest.serializer(), request)}}"""
    ...
    fun `test writeTextFile handler calls client`() = runTest {
        ...
        val requestJson = """{"jsonrpc":"2.0","id":43,"method":"fs/write_text_file","params":${ACPJson.encodeToString(WriteTextFileRequest.serializer(), request)}}"""
        clientTransport.receiveMessage(requestJson)
    ...
    fun `test requestPermission handler calls client and returns response`() = runTest {
        ...
        val requestJson = """{"jsonrpc":"2.0","id":44,"method":"session/request_permission","params":${ACPJson.encodeToString(RequestPermissionRequest.serializer(), request)}}"""
        clientTransport.receiveMessage(requestJson)
    ...
    fun `test sessionUpdate handler calls client`() = runTest {
        ...
        val notificationJson = """{"jsonrpc":"2.0","method":"session/update","params":${ACPJson.encodeToString(SessionNotification.serializer(), notification)}}"""
    ...
    fun `test bidirectional communication with file operations`() = runTest {
        ...
        val requestJson = """{"jsonrpc":"2.0","id":100,"method":"fs/read_text_file","params":${ACPJson.encodeToString(ReadTextFileRequest.serializer(), fileReadRequest)}}"""
        clientTransport.receiveMessage(requestJson)
